...
class VotingTestCase(BaseTestCase):
    ...
    def test_check_inputFile(self):
        ...
        filePath = THIS_FOLDER 
        + '/docs/CandidatesFiles/Candidatos_Senado.xlsx'
        ...
        filePath = THIS_FOLDER 
        + '/docs/CandidatesFiles/Candidatos_Senado2.xlsx'
        try:
            Voting.checkInputFile(filePath)
        except:
        ...
        filePath = THIS_FOLDER 
        + '/docs/CandidatesFiles/Candidatos_Senado3.xlsx'
        try:
            Voting.checkInputFile(filePath)
        except:
        ...
        filePath = THIS_FOLDER 
        + '/docs/CandidatesFiles/Candidatos_Senado4.xlsx'
        try:
            Voting.checkInputFile(filePath)
        except:
            print('Test negativo de 6 candidatos/provincia/partido político'+ 
            'y relación 1/2 correcto')